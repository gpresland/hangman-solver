...
var Dictionary = /** @class */ (function () {
    ...
    Object.defineProperty(Dictionary.prototype, "allWords", {
        /**
         * List of all legal words.
         */
        get: function () {
    ...
    Object.defineProperty(Dictionary.prototype, "possibleWords", {
        /**
         * List of all remaining possible words.
         */
        get: function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var data = fs_1.default.readFileSync(WORD_FILE_PATH);
                        _this._allWords = data.toString().split('\n');
                        resolve();
                        // TODO:
                        // Use stream.
                        // const reader = readline.createInterface({
                        //   input: fs.createReadStream(WORD_FILE_PATH)
                        // });
                        // reader.on('line', (line) => {
